...
function error() {
  ...
  <nav>
    <ul>
      ...
      <li><a href="modernizr.shtml">Modernizr</a></li>
      <li><a href="audio.shtml">Audio</a></li>
      <li><a href="video.shtml">Video</a></li>
      <li><a href="svg.shtml">SVG</a></li>
      <li><a href="geolocation.html">Geo Location</a></li>
      <li><a href="canvas.shtml">Canvas</a></li>
    </ul>
  </nav>
  <div id="content">
  <div id="mcontent">
  ...
  <!-- Defining Footer -->
  <footer>
    <section>HTML5 Examples by Alan Pasho, Common Sense </section>
  </footer>
	</body>
</html>